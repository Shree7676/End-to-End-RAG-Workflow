...
class MarkdownExtractor:
    ...
    def convert_to_markdown(self, input_path, output_md_path):
    ...
    def msg_to_markdown(self, msg_path, output_md_path):
        """Convert .msg email file to a .md (Markdown) file."""
        logger.info(f"Converting MSG to Markdown: {msg_path}")
        
        msg = extract_msg.Message(msg_path)
        msg_subject = msg.subject.replace(" ", "_").replace("/", "-")  # Sanitize filename
        msg_body = msg.body
        msg_date = msg.date
